...
export default function PurchasedPage() {
  ...
  const handleMoveBackToWishlist = async (itemId: string) => {
    if (!confirm('Move this item back to your wishlist?')) return
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-zinc-500 dark:text-zinc-400">
                  {items.length} item{items.length !== 1 ? 's' : ''} you've bought
                </p>
              </div>
            </div>
          </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {items.length === 0 ? (
          <div className="text-center py-20">
            ...
            <h2 className="text-lg font-medium text-zinc-900 dark:text-zinc-100 mb-2">No purchased items yet</h2>
            <p className="text-zinc-500 dark:text-zinc-400 mb-6">
              Items you mark as "Just Got It" will appear here
            </p>
            <Link
              href="/dashboard"
                ...
                >
                  ...
                  <div className="relative aspect-[4/5] overflow-hidden bg-zinc-100 dark:bg-dpurple-800">
                    {item.image_url ? (
                      ...
                      <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-green-50 to-emerald-50 dark:from-zinc-900 dark:to-zinc-800">
