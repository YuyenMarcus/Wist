      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {items.length === 0 ? (
          <div className="text-center py-20">
            ...
            <h2 className="text-lg font-medium text-zinc-900 mb-2">No purchased items yet</h2>
            ...
            <AnimatePresence>
              {items.map((item) => (
                <motion.div
                  ...
                  className="group relative bg-white rounded-xl overflow-hidden border border-zinc-200 hover:border-green-500 hover:shadow-lg transition-all duration-300"
                >
                  {/* Purchased Badge */}
