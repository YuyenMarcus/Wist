            ...
            <AnimatePresence>
              {items.map((item) => (
                <motion.div
                  ...
                  className="group relative bg-beige-100 dark:bg-dpurple-950 rounded-xl overflow-hidden border border-beige-200 dark:border-dpurple-700 hover:border-zinc-400 hover:shadow-lg transition-all duration-300"
                >
                  {/* Hidden Badge */}
