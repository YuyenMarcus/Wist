      ...
      <button
        ...
        className={`flex items-center gap-2 rounded-full text-sm font-medium border transition-colors p-2 sm:px-4 sm:py-2 ${
          success
            ...
            : 'bg-white/80 dark:bg-dpurple-900/80 backdrop-blur-sm text-zinc-500 dark:text-zinc-400 border-white/60 dark:border-dpurple-600 hover:bg-violet-50 dark:hover:bg-violet-950 hover:text-violet-600 dark:hover:text-violet-400 hover:border-violet-300 dark:hover:border-violet-800'
        }`}
        title="Share List"
      >
        {success ? (
