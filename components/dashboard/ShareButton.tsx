...
export default function ShareButton() {
  ...
  return (
    <>
      <button
        onClick={handleShare}
        className="flex items-center gap-2 px-4 py-2 bg-beige-100 dark:bg-dpurple-900 text-zinc-600 dark:text-zinc-400 rounded-full text-sm font-medium border border-zinc-200 dark:border-dpurple-600 hover:bg-violet-50 dark:hover:bg-violet-950 hover:text-violet-600 dark:hover:text-violet-400 hover:border-violet-300 dark:hover:border-violet-800 transition-colors"
      >
        <svg
          className="w-4 h-4"
          fill="none"
