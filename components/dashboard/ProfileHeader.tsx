  ...
  return (
    <div className="w-full max-w-2xl mx-auto pt-12 pb-8 px-4">
      ...
      <div className="flex items-start justify-between mb-8">
        ...
        {/* Stats (Social Proof) */}
        <div className="flex gap-6 pt-3 text-center flex-shrink-0 items-start">
          <div>
            <div className="text-lg font-bold text-zinc-900 h-7 flex items-center justify-center">{itemCount}</div>
          ...
          <Link href="/dashboard/purchased" className="group">
            <div className="text-lg font-bold text-zinc-900 group-hover:text-green-600 transition-colors h-7 flex items-center justify-center">
