    ...
    <div className={`min-h-screen ${theme.bg} transition-colors`}>
      ...
      <div className="fixed bottom-0 inset-x-0 z-50 pointer-events-none">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pb-5">
          <div className={`pointer-events-auto flex items-center justify-between gap-4 rounded-2xl ${isDarkTheme ? 'bg-zinc-900/80 border-zinc-700/60' : 'bg-white/80 border-zinc-200'} backdrop-blur-xl border shadow-lg px-5 py-3.5`}>
            <div className="flex items-center gap-2.5 min-w-0">
              <div className={`flex-shrink-0 w-8 h-8 rounded-lg bg-gradient-to-br ${theme.avatarGradient} flex items-center justify-center`}>
            ...
            <Link
              href="/signup"
              className={`flex-shrink-0 inline-flex items-center gap-1.5 bg-gradient-to-r ${theme.avatarGradient} text-white text-sm font-semibold px-5 py-2.5 rounded-xl transition-opacity hover:opacity-90 shadow-sm`}
            >
              Get your Wist
            </Link>
          </div>
