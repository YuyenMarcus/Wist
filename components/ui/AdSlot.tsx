...
export default function AdSlot({ variant, tier }: AdSlotProps) {
  ...
  if (variant === 'banner') {
    return (
      ...
      >
        <div className="relative rounded-xl border border-dashed border-zinc-200 dark:border-dpurple-700 bg-zinc-50/60 dark:bg-dpurple-900/60 p-4 flex items-center justify-between gap-4 overflow-hidden">
          <div className="flex items-center gap-3 min-w-0">
            <div className="w-8 h-8 rounded-lg bg-violet-100 dark:bg-violet-950/50 flex items-center justify-center flex-shrink-0">
              <Megaphone className="w-4 h-4 text-violet-500 dark:text-violet-400" />
            </div>
            <div className="min-w-0">
              <p className="text-sm font-medium text-zinc-700 dark:text-zinc-200 truncate">Upgrade to remove ads</p>
          ...
          <span className="absolute top-1.5 right-1.5 text-[9px] text-zinc-300 dark:text-zinc-600 font-medium uppercase tracking-wider">Ad</span>
        </div>
      </div>
    )
  }
  ...
  if (variant === 'inline') {
    return (
      ...
      >
        <div className="rounded-xl border border-dashed border-zinc-200 dark:border-dpurple-700 bg-zinc-50/60 dark:bg-dpurple-900/60 p-5 flex flex-col items-center justify-center text-center min-h-[180px] relative">
          <div className="w-10 h-10 rounded-xl bg-violet-100 dark:bg-violet-950/50 flex items-center justify-center mb-3">
            <Megaphone className="w-5 h-5 text-violet-500 dark:text-violet-400" />
          </div>
          ...
          <span className="absolute top-2 right-2 text-[9px] text-zinc-300 dark:text-zinc-600 font-medium uppercase tracking-wider">Ad</span>
        </div>
      </div>
    )
  }
  ...
  if (variant === 'sidebar') {
    return (
      ...
      >
        <div className="rounded-xl border border-dashed border-zinc-200 dark:border-dpurple-700 bg-zinc-50/60 dark:bg-dpurple-900/60 p-3 flex flex-col items-center text-center relative">
          <div className="w-8 h-8 rounded-lg bg-violet-100 dark:bg-violet-950/50 flex items-center justify-center mb-2">
            <Megaphone className="w-4 h-4 text-violet-500 dark:text-violet-400" />
          </div>
          ...
          <span className="absolute top-1.5 right-1.5 text-[8px] text-zinc-300 dark:text-zinc-600 font-medium uppercase tracking-wider">Ad</span>
        </div>
      </div>
    )
  }
