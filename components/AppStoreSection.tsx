...
export default function AppStoreSection() {
  return (
    ...
    >
      ...
      <div className="relative max-w-6xl mx-auto rounded-3xl border border-violet-200/60 bg-white/50 backdrop-blur-sm p-10 sm:p-14 lg:p-20 flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
        {/* Phone mockup */}
